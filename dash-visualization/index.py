...
from apps import vgames, global_sales, trend_category
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Link('Trend Category', href='/apps/trend_category'),
    ], className="row"),
...
def display_page(pathname):
    ...
    if pathname == '/apps/trend_category':
        return trend_category.layout
    else:
